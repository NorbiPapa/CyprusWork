document.addEventListener('DOMContentLoaded', ()=>{
    ...
    function course1()
    {
        ...
        erasmusli1.style.color='black';
        erasmusli2.style.color='white';
        erasmusli3.style.color="white";
    ...
    function course2()
    {
        ...
        erasmusli3.style.backgroundColor='#223832';
        erasmusli2.style.color='black';
        erasmusli1.style.color='white';
        erasmusli3.style.color="white";
