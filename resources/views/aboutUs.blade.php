...
<body>
    ...
    <div id="about">
        <!-- First row with description and image -->
        <div class="row">
            ...
            <div class="col-5 d-flex justify-content-center align-items-center">
                <img class="aboutUsImage" src="pictures/goats.png" alt="">
            </div>
        </div>

        <!-- Second row with images and text about animals -->
        <div class="row">
            <!-- Column with images of dogs, horse, and goats -->
            <div class="col-6 d-flex justify-content-center align-items-center">
                <div class="col-4">
                    <img class="aboutUsImage mb-4" src="pictures/dogs.png" alt="The Kleos Royal Labradors">
                    <img class="aboutUsImage" src="pictures/dogs2.png" alt="The Kleos Royal Labradors">
                </div>
                <div class="col-4">
                    <img class="aboutUsImage mb-4" src="pictures/horse.png" alt="Horse">
                    <img class="aboutUsImage" src="pictures/goats2.png" alt="Goats">
                </div>
            </div>
            <!-- Column with text about animals at Kleos -->
            <div class="col-5 d-flex justify-content-center align-items-center">
                <div id="abouttext">
        ...
        <!-- Third row with a detailed description and images -->
        <div class="row">
            <!-- Column with detailed text about the farm's practices -->
            ...
            <!-- Column with images of farm products -->
            <div class="col d-flex justify-content-center align-items-center">
                <img class="aboutUsImage me-4" src="pictures/herb2.png" alt="Herb">
                <img class="aboutUsImage" src="pictures/fruit1.png" alt="Fruit">
            </div>
        </div>

        <!-- Fourth row with images and text about student activities -->
        <div class="row">
            <!-- Column with images of students -->
            <div class="col d-flex justify-content-center align-items-center">
                <div class="col-4">
                    <img class="aboutUsImage mb-4" src="pictures/students.png" alt="">
                    <img class="aboutUsImage" src="pictures/students2.png" alt="">
                </div>
                <div class="col-4">
                    <img class="aboutUsImage mb-4" src="pictures/students3.png" alt="">
                    <img class="aboutUsImage" src="pictures/students4.png" alt="">
                </div>
            </div>
            <!-- Column with text about student activities -->
            <div class="col d-flex justify-content-center align-items-center">
                <div id="abouttext">
        ...
        <!-- Fifth row with a focus on job opportunities for students -->
        <div class="row">
            <!-- Column with text about job opportunities for students -->
            <div class="col d-flex justify-content-center align-items-center">
                <div id="abouttext">
                    <h2>We will find a job for every student</h2>
                    <hr>
            ...
            <!-- Column with images of students in various activities -->
            <div class="col d-flex justify-content-center align-items-center">
                <div class="col-4">
                    <img class="aboutUsImage mb-4" src="pictures/student5.png" alt="">
                    <img class="aboutUsImage" src="pictures/student6.png" alt="">
                </div>
                <div class="col-4">
                    <img class="aboutUsImage mb-4" src="pictures/student7.png" alt="">
                    <img class="aboutUsImage" src="pictures/student8.png" alt="">
                </div>
            </div>
        </div>
    </div>
